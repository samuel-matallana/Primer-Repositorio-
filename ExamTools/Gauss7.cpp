...
int main(void){
    ...
    double GaussN= gaussN(-2.0, 2.0, f, 7);
    double error_gauss2 = std::abs(1.0 - GaussN/exact_result);
    double gauss_quadrature3 = gauss3(-2.0, 2.0, f);
    double error_gaussN = std::abs(1.0 - GaussN/exact_result);
    file << N << " "
            << trapezoid_result << " "
            << error_trapezoid << " "
